...
<h2 className="mt-2 text-lg font-bold mr-auto">{project?.title}</h2>

<div className="mt-2">
    <a href={project?.github} className="inline-block ml-3" target="_blank">
    <Icon icon="la:github" width={50}/>
    </a>

    <a href={project?.netlify} className="inline-block ml-3" target="_blank">
    <Icon icon="devicon:netlify" width={50}/>
    </a>
  </div>
</div>
